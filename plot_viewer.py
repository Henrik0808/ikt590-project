...
def render_plot_sup_down(sup, down):
    ...
    ax.plot(epoch_sup, loss_train_sup, label='Training sup')
    ax.plot(epoch_down, loss_train_down, label='Training down')
    ax.plot(epoch_sup, loss_valid_sup, label='Validation sup')
    ax.plot(epoch_down, loss_valid_down, label='Validation down')
    ax.set_xlabel('Epoch')
    ax.set_ylabel('Loss')
    plt.legend()
